...
saveRDS(sce, file = 'sce_windows_colon.rds')
```
...
adj_sampens_long <- lapply(sampens, function(s) {
  data.frame(
...
```{r r2_win_scatter, fig.width = 7, fig.height = 6}
...
```{r adjH_adjS_medians, fig.width = 10, fig.height = 6}
hm_win <- inner_join(
  adj_shannons_long %>%
