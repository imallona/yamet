...
process_file <- function(filepath) {
  filename <- gsub('.hmm.', '_hmm_', basename(filepath), fixed = TRUE) # dirty fix for an upstream problem
...
## print(unique(files$patient))
## print(unique(files$location))
...
# Still exploratory - on ranks {.tabset .tabset-pills}
...
## Ranks associations - by shannon NC
