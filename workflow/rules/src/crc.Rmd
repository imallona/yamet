...
plot(pmds, pch = ".", col = as.numeric(pmds$by_meth_nc))
```


Colored by median sampEn in PT.

```{r, fig.width = 10, fig.height = 10}
pmds$by_med_sampen_pt <- cut(pmds$med_sampen_PT, breaks = 10)
plot(pmds, pch = ".", col = as.numeric(pmds$by_med_sampen_pt))

```

Colored by median sampEn in NC.

```{r, fig.width = 10, fig.height = 10}
pmds$by_med_sampen_nc <- cut(pmds$med_sampen_NC, breaks = 10)
plot(pmds, pch = ".", col = as.numeric(pmds$by_med_sampen_nc))
