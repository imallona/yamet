...
arranged <- ggarrange(
  ...
  ggarrange(
    ...
    ggarrange(
      s_plots$nmi   + theme(legend.position = "none"),
      s_plots$seconds  + theme(legend.position = "none"),
      s_plots$mem + theme(legend.position = "none"),
      n_plots$nmi   + theme(legend.position = "none"),
      n_plots$seconds  + theme(legend.position = "none"),
      n_plots$mem   + theme(legend.position = "none"),
      ncol = 3,
      nrow = 2
    ),
