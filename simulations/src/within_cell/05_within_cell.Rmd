...
saveRDS(all.long,  'rds/all.long_within.rds')
saveRDS(jnt,       'rds/jnt_within.rds')
saveRDS(s_plots,   'rds/s_plots_within.rds')
saveRDS(n_plots,   'rds/n_plots_within.rds')
```
...
saveRDS(mi_fd_adj,    'rds/perf_within_adj.rds')
saveRDS(all.long_adj, 'rds/all.long_within_adj.rds')
saveRDS(jnt,          'rds/jnt_within_adj.rds')
saveRDS(s_plots_adj,  'rds/s_plots_within_adj.rds')
saveRDS(n_plots_adj,  'rds/n_plots_within_adj.rds')
```
