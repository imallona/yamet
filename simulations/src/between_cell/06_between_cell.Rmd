...
saveRDS(mi_fd_adj,    'rds/perf_across_adj.rds')
saveRDS(all.long_adj, 'rds/all.long_across_adj.rds')
saveRDS(jnt,          'rds/jnt_across_adj.rds')
saveRDS(s_plots_adj,  'rds/s_plots_across_adj.rds')
saveRDS(n_plots_adj,  'rds/n_plots_across_adj.rds')
```
