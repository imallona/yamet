...
outDir <- file.path("..", "output/sim_data_coverage")
...
saveRDS(ovCovDt, file.path(outDir, "overall_coverage.rds"))
...
saveRDS(strLenDt, file.path(outDir, "covered_stretches_length.rds"))
