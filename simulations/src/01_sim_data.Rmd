...
for (i in 1:nrow(paramGrid)) {
  ...
  if (paramsSet$transMat == "hmrRand") {
    transMat <- matrix(c(0.2, 0.2, 0.8, 0.8), nrow = 2, ncol = 2)
    estimateTransMat <- FALSE
  } else if (paramsSet$transMat == "hmrCons"){
    transMat <- matrix(c(0.6, 0.1, 0.4, 0.9), nrow = 2, ncol = 2)
    estimateTransMat <- FALSE
  } else if (paramsSet$transMat == "lmrRand") {
    transMat <- matrix(c(0.8, 0.8, 0.2, 0.2), nrow = 2, ncol = 2)
    estimateTransMat <- FALSE
  } else if (paramsSet$transMat == "lmrCons") {
    transMat <- matrix(c(0.9, 0.4, 0.1, 0.6), nrow = 2, ncol = 2)
    estimateTransMat <- FALSE
