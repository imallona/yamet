...
```{r}
NTHREADS = 5
CLINICAL_DATA_PATH = file.path('data', '41591_2018_156_MOESM3_ESM.csv')
```
...
for (fn in list.files('.', pattern = '.*average_methylation_promoter.bed.gz', recursive = TRUE)) {
    tryCatch({
...
Filling it with the average of averages DNA methylation entropies and beta values.
@todo fix nas
