...
build_tuple_scaffold <- function(num_tuples, tuple_length = 2) {
...
simulate_full_meth <- function(chrom, num_tuples, average_depth, std_depth, tuple_distance, tuple_length) {
    ...
    d[,'MM']  <- round(truncnorm::rtruncnorm(num_tuples, a = 1, b = Inf,
                                       mean = average_depth,
                                       sd = std_depth))
...
simulate_infinite_haplotypes <- function(chrom, num_tuples, average_depth,
    ...
    d[,'UU'] <- round(truncnorm::rtruncnorm(num_tuples, a = 0, b = Inf,
                                            mean = average_depth/4,
                                            sd = std_depth/2))

    set.seed(2)
    
    d[,'UM'] <- round(truncnorm::rtruncnorm(num_tuples, a = 0, b = Inf,
                                            mean = average_depth/4,
                                            sd = std_depth/2))    
    set.seed(99)

    d[,'MU'] <- round(truncnorm::rtruncnorm(num_tuples, a = 0, b = Inf,
                                            mean = average_depth/4,
                                            sd = std_depth/2))
    set.seed(666)

    d[,'MM'] <- round(truncnorm::rtruncnorm(num_tuples, a = 0, b = Inf,
                                            mean = average_depth/4,
                                            sd = std_depth/2))
...
sims$entropic <- simulate_infinite_haplotypes(chrom = 'chr19', num_tuples = 10000,
                               average_depth = 10,
                               std_depth = 5,
                               tuple_distance = 20)
...
simulate_boundary <- function(chrom, num_tuples, average_depth,
    ...
    d[,'UM'] <- round(truncnorm::rtruncnorm(num_tuples, a = 1, b = Inf,
                                            mean = average_depth,
                                            sd = std_depth))
    d[,'UU'] <- 0
    d[,'MU'] <- 0
