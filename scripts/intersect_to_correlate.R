...
CairoPNG('correlation_encode_std_entropies.png', width= 600, height = 600)
...
mtext("standardized entropy (stdH)", side = 1, line = -2, outer = TRUE,  cex = 1.2)
## mtext("standardized entropy (stdH)", side = 2, line = 40, adj =40)
mtext("standardized entropy (stdH)", side = 2, line = -2, outer = TRUE, cex = 1.2)
